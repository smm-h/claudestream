...
class TestCmdSendErrorHandling:
    ...
    def test_claude_stream_error(self, mock_cls, capsys):
        ...
        result = cmd_send(None, "hello", model="sonnet", profile="test")
        assert result == 1
...
class TestCmdStreamErrorHandling:
    ...
    def test_claude_stream_error(self, mock_cls, capsys):
        ...
        result = cmd_stream(None, "hello", model="sonnet", profile="test")
        assert result == 1
...
class TestCmdEventsErrorHandling:
    ...
    def test_claude_stream_error(self, mock_cls, capsys):
        ...
        result = cmd_events(None, "hello", model="sonnet", profile="test")
        assert result == 1
